...
public class LevelFourth extends AppCompatActivity {
    Button goButton;
 ...
 */
    public void newQuestion() {
        ...
        double b = rand.nextInt(20);
        double a = b*rand.nextInt(30);

        if (a > b) {
            sumTextView.setText(Integer.toString((int) a) + " / " + Integer.toString((int) b) + " = ?");
            ...
            for (int i = 0; i < 4; i++) {
                if (i == locationOfCorrectAnswer) {
                    ...
                    int wrongAnswer = rand.nextInt(30);
                    while (wrongAnswer == a * b) {
                        wrongAnswer = rand.nextInt(30);
                    }
                }
...
/*
    ...
    public void onBackPressed() {
        startActivity(new Intent(LevelFourth.this , LevelMenu.class));
